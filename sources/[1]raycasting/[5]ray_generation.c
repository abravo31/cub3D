...
static void	get_direction_ray(t_rc *rc, t_ray *ray, t_vec2D ray_vec)
{
...
static void	draw_ray(t_cub3D *data, t_rc *rc, t_vec2D ray_vec)
{
	t_ray		ray;
	t_vec2D		ray_screen;
	...
	get_direction_ray(rc, &ray, ray_vec);
